...
if (isset($_POST['title']) && isset($_POST['lat']) && isset($_POST['lng'])) {
    ...
    // Assuming your table is named 'markers1_100' and has columns 'latitude' and 'longitude'
    $query = "DELETE FROM markers1_100 WHERE title = '$title' AND `lat` = $lat AND `lng` = $lng";
