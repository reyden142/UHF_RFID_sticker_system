...
if (isset($_POST['title']) && isset($_POST['lat']) && isset($_POST['lng'])) {
    ...
    // Assuming your table is named 'markers2_100' and has columns 'latitude' and 'longitude'
    $query = "DELETE FROM markers2_100 WHERE title = '$title' AND `lat` = $lat AND `lng` = $lng";
